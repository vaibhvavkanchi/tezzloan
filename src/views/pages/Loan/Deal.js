        ...
        <StyledBox>
            <Box className="flex flex-col items-center w-full" sx={{ width: "calc(100% - 200px)" }}>
                <BorderLinearProgress
                    ...
                    value={!otpsend ? 50 : 75}
                />
                <Typography className={`headTitle1 mt-10 mb-11 uppercase ${!otpsend ? "mb-11" : "mt-9"}" `}>{!otpsend ? "Commercial property loan" : "HOME LOAN"}</Typography>
                ...
                {!otpsend ? <>
                    ...
                    />
                    <Typography variant="body2" style={{color:"#3C3C3C"}} className="text-xs mt-6">
                    ...
                    <Typography className="mt-10 mb-24 text-center text-sm leading-10">
                        ...
                        <span className="blueText cursor-pointer">Credit Report Terms of Use, Terms of Use & Privacy Policy.</span>
                    </Typography>
                </> :
                    <div className="mt-4 flex flex-col items-center justify-center">
                        <Typography variant="body2" className="offerText mb-14 text-center">
                            Enter the 5-digit confirmation code that has been sent to  +91-{maskMiddleCharacters(number)} <span onClick={() => { setSendOtp(!otpsend) }} className="blueText cursor-pointer">edit</span>
                        </Typography>
